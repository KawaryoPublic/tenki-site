    ...
    <html lang="ja">
      <body className="min-h-screen overflow-x-hidden flex flex-col items-center">
        <div className="fixed z-[-1] top-0 left-0 w-full h-screen">
          <Image src="/image/bg_pc.webp" alt="背景" fill priority sizes="object-cover max-sm:hidden" />
          <Image src="/image/bg_phone.webp" alt="背景" fill priority sizes="object-cover sm:hidden" />
