  ...
  return (
    <header className="z-2 text-gray-900 pt-2 md:pt-4 pl-2 md:pl-4 w-full flex items-center bg-gray-300 whitespace-nowrap">
        <div className="relative w-[20%] md:w-[30%] min-w-30 max-w-50 aspect-[1167/385] mb-2">
          <Image src="/image/logo.webp" alt="部員はこちら" fill priority sizes="w-full h-full" />
        </div>
        ...
        <Link href="/password" className="relative w-[4%] md:w-[6%] min-w-8 max-w-10 ml-auto mr-2 md:mr-4 aspect-square bg-blue-500 hover:bg-blue-600 focus:outline-2 focus:outline-offset-2 focus:outline-blue-600 text-whitextext-sm md:text-base rounded">
