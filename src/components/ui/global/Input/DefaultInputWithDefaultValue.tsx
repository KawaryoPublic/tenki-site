export default function DefaultInput({ title, name, type = "text", defaultValue = "", className = "", label = false }: { title: string, name: string, type?: string, defaultValue?: string, className?: string, label?: boolean }) {
    return (
