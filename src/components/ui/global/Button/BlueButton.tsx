...
export default function BlueButton({ children, onClick, href, type = "submit", className = "" }: { children: ReactNode, onClick?: () => void, href?: string, type?: "button" | "submit" | "reset" | "undefined", className?: string }) {
    return (
        href ? 
