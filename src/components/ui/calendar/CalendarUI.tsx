...
import DayElement from "./DayUI";
import DateElement from "./DateUI";
import { DateInfo, TIER } from "@/lib/type";

export default function Calendar({ index, tier, filter, dateInfo, observationDays }: { index: number, tier: TIER, filter: string, dateInfo: DateInfo[], observationDays: Number[] }) {
